namespace RSMNG.TAUMEDIKA.DataModel
{
	...
	/// <summary>
	/// Riga ordine constants.
	/// </summary>
	public sealed class salesorderdetail : EntityGenericConstants
	{
		/// <summary>
		/// salesorderdetail
		/// </summary>
		public static string logicalName => "salesorderdetail";

		/// <summary>
		/// Riga ordine
		/// </summary>
		public static string displayName => "Riga ordine";

		/// <summary>
		/// Display Name: Importo,
		/// Type: Money,
		/// Description: Mostra il prezzo totale del prodotto dell'ordine, in base al prezzo unitario, allo sconto per volume e alla quantità.
		/// </summary>
		...
		/// Type: Memo,
		/// Description: Digitare informazioni aggiuntive per descrivere il prodotto dell'ordine, ad esempio dettagli di produzione o sostituzioni accettabili.
		/// </summary>
		...
		/// Type: Money,
		/// Description: Mostra l'importo totale dovuto per il prodotto dell'ordine in base alla somma del prezzo unitario, della quantità, degli sconti e delle imposte.
		/// </summary>
		...
		/// <summary>
		/// Display Name: Copiato,
		/// Type: Boolean,
		/// Values:
		/// Sì: 1,
		/// No: 0,
		/// Description: Specificare se la voce della fattura viene copiata da un altro elemento o da un'altra origine dati.
		/// </summary>
		...
		/// Usa predefinito: 0,
		/// Description: Specificare se il prezzo unitario è fissato sul valore del listino prezzi indicato o se può essere sostituito dagli utenti con diritti di modifica sui prodotti dell'ordine.
		/// </summary>
		...
		/// Fuori catalogo: 1,
		/// Esistente: 0,
		/// Description: Specifica se il prodotto esiste nel catalogo prodotti di Microsoft Dynamics 365 o se è un prodotto fuori catalogo specifico dell'ordine padre.
		/// </summary>
		...
		/// Type: Integer,
		/// Description: Digitare il numero della voce del prodotto dell'ordine per identificare agevolmente il prodotto e garantire che sia elencato nell'ordine corretto.
		/// </summary>
		...
		/// Type: Money,
		/// Description: Digitare l'importo dello sconto manuale per il prodotto dell'ordine per dedurre qualsiasi risparmio negoziato o diverso dal totale relativo ai prodotti inclusi nell'ordine.
		/// </summary>
		...
		/// Type: Lookup,
		/// Related entities: salesorderdetail,
		/// Description: Scegli l'aggregazione padre associata a questo prodotto
		/// </summary>
		...
		/// Type: Money,
		/// Description: Digitare il prezzo unitario del prodotto dell'ordine. Il valore predefinito è quello del listino prezzi specificato nell'ordine per i prodotti esistenti.
		/// </summary>
		...
		/// Type: Uniqueidentifier,
		/// Description: Identificatore univoco dell'associazione della voce prodotto all'aggregazione nell'ordine di vendita
		/// </summary>
		...
		/// Type: String,
		/// Description: Digita un nome o una descrizione per identificare il tipo di prodotto fuori catalogo incluso nell'ordine.
		/// </summary>
		...
		/// Description: Scegli il prodotto da includere nell'ordine per collegarne prezzo e altre informazioni all'ordine padre.
		/// </summary>
		...
		/// Type: Decimal,
		/// Description: Digitare l'importo o la quantità del prodotto ordinato dal cliente.
		/// </summary>
		public static string quantity => "quantity";

		/// <summary>
		/// Display Name: Quantità inevasa,
		/// Type: Decimal,
		/// Description: Digitare l'importo o la quantità del prodotto inevaso per l'ordine.
		/// </summary>
		public static string quantitybackordered => "quantitybackordered";

		/// <summary>
		/// Display Name: Quantità annullata,
		/// Type: Decimal,
		/// Description: Digitare l'importo o la quantità del prodotto annullato.
		/// </summary>
		public static string quantitycancelled => "quantitycancelled";

		/// <summary>
		/// Display Name: Quantità consegnata,
		/// Type: Decimal,
		/// Description: Digitare l'importo o la quantità del prodotto consegnato per l'ordine.
		/// </summary>
		public static string quantityshipped => "quantityshipped";

		/// <summary>
		/// Display Name: ID prodotto offerta,
		/// Type: Lookup,
		/// Related entities: quotedetail,
		/// Description: Identificatore univoco per la riga di offerta associata a Riga ordine.
		/// </summary>
		...
		/// Type: DateTime,
		/// Description: Immettere la data di consegna richiesta dal cliente per il prodotto dell'ordine.
		/// </summary>
		...
		/// Description: 
		/// </summary>
		public static string res_discountpercentage1 => "res_discountpercentage1";
		...
		/// Description: 
		/// </summary>
		public static string res_discountpercentage2 => "res_discountpercentage2";
		...
		/// Description: 
		/// </summary>
		public static string res_discountpercentage3 => "res_discountpercentage3";
		...
		/// <summary>
		/// Display Name: Prodotto ordine,
		/// Type: Uniqueidentifier,
		/// Description: Identificatore univoco del prodotto specificato nell'ordine.
		/// </summary>
		...
		/// Display Name: Nome,
		/// Type: String,
		/// Description: Nome dettagli ordine di vendita. Aggiunto per relazione referenziale 1:n (solo per scopi interni)
		/// </summary>
		public static string salesorderdetailname => "salesorderdetailname";

		/// <summary>
		/// Display Name: Ordine,
		/// Type: Lookup,
		/// Related entities: salesorder,
		/// Description: Mostra l'ordine per il prodotto. L'ID consente di collegare il prezzo e altri dettagli del prodotto agli importi totali e ad altre informazioni presenti sull'ordine.
		/// </summary>
		public static string salesorderid => "salesorderid";

		/// <summary>
		/// Display Name: Prezzi dell'ordine bloccati,
		/// Type: Boolean,
		/// Values:
		/// Sì: 1,
		/// No: 0,
		/// Description: Indica se i prezzi dei prodotti sono bloccati per l'ordine.
		/// </summary>
		public static string salesorderispricelocked => "salesorderispricelocked";

		/// <summary>
		/// Display Name: Stato ordine,
		/// Type: Picklist,
		/// Values:
		/// Description: Mostra lo stato dell'ordine a cui sono associati i dettagli.
		/// </summary>
		public static string salesorderstatecode => "salesorderstatecode";

		/// <summary>
		/// Display Name: Venditore,
		/// Type: Lookup,
		/// Related entities: systemuser,
		/// Description: Scegli l'utente responsabile della vendita del prodotto dell'ordine.
		/// </summary>
		...
		/// Type: Integer,
		/// Description: Mostra l'ID dei dati relativi alla sequenza.
		/// </summary>
		...
		/// Description: Ignora il calcolo del prezzo
		/// </summary>
		...
		/// Type: Money,
		/// Description: Digitare l'importo delle imposte per il prodotto dell'ordine.
		/// </summary>
		...
		/// Indirizzo: 0,
		/// Description: Specificare se il prodotto dell'ordine deve essere consegnato all'indirizzo indicato o trattenuto fino a quando il cliente non impartisce ulteriori istruzioni di ritiro o dl consegna.
		/// </summary>
		...
		/// <summary>
		/// Values for field Prezzi dell'ordine bloccati
		/// <summary>
		public enum salesorderispricelockedValues
		{
			No = 0,
			Si = 1
		}
